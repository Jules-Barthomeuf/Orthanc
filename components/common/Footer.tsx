...
export function Footer() {
  return (
    <footer className="border-t border-dark-700/50 bg-dark-900 py-16">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 mb-10">
          <div>
            <h3 className="text-xl font-bold text-teal-400 mb-4 tracking-wider">
              ORTHANC
            </h3>
          ...
          <div>
            <h4 className="label-luxury text-teal-400/70 mb-4">Platform</h4>
          ...
          <div>
            <h4 className="label-luxury text-teal-400/70 mb-4">Legal</h4>
            <ul className="space-y-3 text-sm text-dark-400">
              <li>
                <a href="#" className="hover:text-teal-400 transition">
                  Privacy Policy
          ...
          <div>
            <h4 className="label-luxury text-teal-400/70 mb-4">Contact</h4>
