        ...
        <div className="max-w-6xl mx-auto px-6 relative z-10">
          <div className="text-center mb-20">
            ...
            <p className="text-dark-400 text-sm mt-6 max-w-2xl mx-auto leading-relaxed">
              We didn't build Orthanc to disrupt. We built it to elevate. Every decision we make is guided by principles that put underwriting integrity, execution quality, and trust above everything else.
            </p>
          </div>
